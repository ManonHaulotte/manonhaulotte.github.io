...
<?php 
  if(isset($_POST['email'])){
	...
	<td align='left' valign='top' style='border-top:1px solid #dfdfdf; font-family:Arial, Helvetica, sans-serif; font-size:13px; color:#000; padding:7px 0 7px 5px;'>".$topic."</td>
	</tr>
	<td align='right' valign='top' style='border-top:1px solid #dfdfdf; font-family:Arial, Helvetica, sans-serif; font-size:13px; color:#000; padding:7px 5px 7px 0;'>How:</td>
	<td align='left' valign='top' style='border-top:1px solid #dfdfdf; font-family:Arial, Helvetica, sans-serif; font-size:13px; color:#000; padding:7px 0 7px 5px;'>".$how."</td>
	</tr>
	<tr>
...
$headers .= 'From: <'.$from.'>' . "\r\n";
   ...
   {
	   //Success Message
      echo "The message has been sent! Thank you, I'll be in touch.";
   }
   else
   {	
   	 //Fail Message
      echo "The message could not been sent. Try again!";
   }
